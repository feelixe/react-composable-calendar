...
import { withYearSelect } from "@/examples/code-examples.ts";
...
* Add <ExternalLink text="Select" href="https://ui.shadcn.com/docs/components/select" />.
* Copy paste this code block into `src/components/ui/calendar.tsx`.

<CodeBlock client:load code={withYearSelect} />
